...
if __name__ == "__main__":
    if (len(sys.argv) == 2):
        ...
        elif (sys.argv[1] == 'train-smart'):
            # Toss, for pmodel: initialize, load, play
            no_games = int(input("Enter the number of random games to train the trained model with [1-10000000]: "))
